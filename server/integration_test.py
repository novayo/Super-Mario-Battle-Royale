...
class TestIntegration(unittest.TestCase):
    ...
    def test_player_removed_on_disconnect(self):
        ...
        self._wait_for(lambda: self.server.port != 0)
        ...
        # update.player_id = "test_player" # Removed
        update.x = 10
        update.y = 20
        ...
        self._wait_for(lambda: "p1" in main.PLAYERS)

        # Disconnect client
        client.close()

        # Wait for disconnect to be processed
        self._wait_for(lambda: "p1" not in main.PLAYERS)
